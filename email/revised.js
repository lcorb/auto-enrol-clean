function generate(title, body, rows, classCode) {
	return `<!DOCTYPE html>
    ...
    <head>
        ...
        <style>
            ...
            .oop:hover {
                background: rgb(211, 126, 33) !important;
                border-color: rgb(211, 126, 33) !important;
            }
            .dne:hover,
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="max-width: 680px; width:100%">
                    ...
                    <tr>
                        <td style="padding: 20px 30px; text-align: left;" class="sm-px">
                                <!-- <img src="https://brisbanesde.eq.edu.au/SiteCollectionImages/sitelogo.png" alt="BrisbaneSDE Logo" border="0" height="70" width="100" style="display: block; font-family: arial, sans-serif; font-size: 15px; line-height: 15px; color: #3C3F44; margin: 0;"> -->
                        </td>
                    </tr>
                    <!-- Logo : END -->
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
                                ...
                                <tr>
                                    <td style="padding-bottom: 10px;">
                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" align="left">
                                            <tr>
                                                <td valign="middle" height="19" width="19" style="font-family: arial, sans-serif; font-size: 15px; line-height: 15px; color: #ffffff; background-color: rgb(156, 87, 235); font-weight: bold; text-align: center; border-radius: 5px; padding: 5px">
                                                    ${classCode}
                                                </td>
                                                <!-- <td valign="middle" style="padding-left: 5px; font-family: arial, sans-serif; font-size: 15px; line-height: 15px; color: #242729; text-align: left;">
                                                    $classname
                                                </td> -->
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td style="padding-bottom: 15px; font-family: arial, sans-serif; font-size: 15px; line-height: 21px; color: #3C3F44; text-align: left;">
                                        <h1 style="font-weight: bold; font-size: 27px; line-height: 27px; color: #0C0D0E; margin: 0 0 15px 0;">${title}</h1>
                                        <p style="margin: 0 0 15px;" class="has-markdown">${body}</p>
                    ...
                    <tr>
                        <td style="padding: 30px;" class="sm-p">
                            <table align="left" border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                ...
                                <tr>
                                    <td style="padding-bottom: 10px; font-size: 12px; line-height: 15px; font-family: arial, sans-serif; color: #9199A1; text-align: center;">
                                        This is an automatically generated email, to confirm the above action.
                                    </td>
                                </tr>
